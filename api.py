# I create a "API" for the movie recommendation system.
# With "FastAPI".
...
# FASTAPI APP.
# =========================
app = FastAPI(title="Movies 😁 Recommendation API🎭", version="1.0")
...
async def search_bundle(
    ...
    """
    when you run this file, you can use the following command:
    (python -m uvicorn api:app --reload)
    (uvicorn api:app --reload)

    First you activate environment
